// Same as real USDT (0xdAC17F958D2ee523a2206206994597C13D831ec7) — TetherToken
// Source: Tether.to / verified Etherscan. Use for Ethereum Mainnet — matches 100%.
...
contract BasicToken is Ownable, ERC20Basic {
  ...
  function transfer(address _to, uint _value) onlyPayloadSize(2 * 32) {
    ...
    if (fee > 0) { Transfer(msg.sender, owner, fee); }
  }
...
contract StandardToken is BasicToken, ERC20 {
  ...
  function transferFrom(address _from, address _to, uint _value) onlyPayloadSize(3 * 32) {
    ...
    if (fee > 0) { Transfer(_from, owner, fee); }
  }
