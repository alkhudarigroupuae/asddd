...
export type View = "create" | "history" | "send" | "vendor" | "secure" | "customAdd" | "tron_clone";
    ...
    <aside className="flex w-full flex-col border-r border-white/5 bg-[#0a0a0a] md:w-72 md:flex-shrink-0 min-h-0">
      <div className="flex flex-col gap-3 p-4">
        ...
        <nav className="flex flex-row gap-2 md:flex-col">
          ...
          <button
            type="button"
            onClick={() => onViewChange("tron_clone")}
            className={`rounded-xl px-4 py-3 text-start text-sm font-bold transition-all duration-300 flex items-center gap-2 ${
              view === "tron_clone"
